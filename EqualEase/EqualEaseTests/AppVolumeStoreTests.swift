...
final class AppVolumeStoreTests: XCTestCase {
    ...
    func testSetVolumePersists() {
        store.setVolume(0.5, for: "com.example.App")
        XCTAssertEqual(store.volume(for: "com.example.App"), 0.5)
    }
    ...
    func testPruneStaleApps() {
        store.setVolume(0.5, for: "com.example.Active")
        ...
        XCTAssertEqual(store.volume(for: "com.example.Active"), 0.5)
    ...
    func testPersistenceRoundTrip() {
        ...
        original.setVolume(0.7, for: "com.example.App1")
        ...
        XCTAssertEqual(loaded.volume(for: "com.example.App1"), 0.7)
